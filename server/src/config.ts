...
export class Config {
  debugLogging = 'debug';
  'server.port' = '8080';
  'jhipster.clientApp.name' = 'myNhipsterApp';
  ...
  'jhipster.mail.from' = 'myNhipsterApp@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'myNhipsterApp API';
  'jhipster.swagger.description' = 'myNhipsterApp API documentation';
  ...
  'eureka.instance.appname' = 'myNhipsterApp';
  'eureka.instance.instanceId' = 'myNhipsterApp:${random.value}';
  ...
  'cloud.config.name' = 'myNhipsterApp';
